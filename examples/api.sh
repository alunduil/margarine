...
# Create an User
curl -v -X PUT http://api.margarine.com/v1/users/${USERNAME} -F "email=username@example.com"
...
# Create an Article
curl -v -X POST http://api.margarine.com/v1/articles/ -F "url=http://developer.rackspace.com/blog/a-look-back-at-pycon-australia-2013.html"

# Read an Article
curl -v -X GET http://api.margarine.com/v1/articles/7d7dae0b-2ed6-53ed-a1c5-5b1245e0f397
