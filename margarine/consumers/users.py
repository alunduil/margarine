...
def register(channel):
    ...
    channel.queue_declare(queue = "margarine.users.create", auto_delete = False, durable = True)
    ...
    channel.queue_declare(queue = "margarine.users.update", auto_delete = False, durable = True)
    ...
    channel.queue_declare(queue = "margarine.users.email", auto_delete = False, durable = True)
    ...
    channel.queue_declare(queue = "margarine.users.password", auto_delete = False, durable = True)
