...
# -*- coding: utf-8 -*-
#
# Margarine documentation build configuration file, created by
...
htmlhelp_basename = 'Margarinedoc'
...
latex_documents = [
  ('index', 'Margarine.tex', 'Margarine Documentation',
   'Alex Brandt', 'manual'),
]
...
man_pages = [
    ('index', 'margarine', 'Margarine Documentation',
     ['Alex Brandt'], 1)
]
...
texinfo_documents = [
  ('index', 'Margarine', 'Margarine Documentation',
   'Alex Brandt', 'Margarine', 'One line description of project.',
   'Miscellaneous'),
]
